...
const ExchangePage: React.FC = () => {
  ...
  const handleExchangeSuccess = (
    ...
    toast.success("Ваш запрос на обмен успешно отправлен!", {
      description: `Номер вашего заказа: ${displayData.orderId}. Вы обменяли ${displayData.fromAmount} ${displayData.paymentCurrency} на ${displayData.calculatedVND.toLocaleString(
        "vi-VN"
      )} VND.`,
      duration: 3000,
      position: "top-center",
  ...
  return (
    ...
    >
      <div className="absolute inset-0 bg-brand-blue/10 backdrop-blur-sm z-0" />
      <ShellCard className="w-full max-w-lg mx-auto shadow-2xl overflow-hidden relative z-10 border-4 border-brand-blue">
        <header className="h-20 bg-white relative flex items-center justify-center">
          <img
